...
\hl{\textbf{Best respondent and headline-level treatments:}} \todo{wasnt sure best place for these}In addition to the above hypotheses related to treatment heterogeneity, we also plan to test heterogeneity with respect to the best performing respondent-level and headline-level treatments. To estimate these we again take the median as the splitting point of continuous covariates to create ``high'' and ``low'' categories: 
...
In addition to treatment effect heterogeneity, we also anticipate that certain types of people are simply more likely to share false information, compared to true information. In particular, we expect that baseline rates of sharing false posts (compared to true posts) will be higher among these subgroups:\todo{I didnt make this about who will just be more likely to share (anything), period. but focused on false info. but could probably apply to both types of sharing...}
\begin{itemize}
\item young
\item male
