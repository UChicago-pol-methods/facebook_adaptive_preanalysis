...
\todo{Response function: optimize to reduce sharing of fake news, while accounting for sharing of true news (willing to tolerate reduction in sharing of true news). Latter is primary interest, what happens with sharing true info of secondary interest.}
