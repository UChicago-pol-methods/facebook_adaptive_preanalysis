...
\end{tabular}
\end{table}
**Last batch size $|\mathcal{I}_B|$ is set at 2200, to sufficiently power a one-sided hypothesis test, Hypothesis~\ref{eq:optctr}, where the optimal contextual policy is .15 standard deviations greater than the control policy. 
