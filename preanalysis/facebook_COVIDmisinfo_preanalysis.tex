...
We report average outcomes under each headline factor level and separately respondent factor level, marginalizing over an equal distribution of levels of the other factor. We note that this is different from the realized distribution of the other factor, as the adaptive design is intentionally unbalanced. We calculate these quantities by averaging across the relevant scores, and taking the standard deviations of the averages. 

To test hypotheses regarding specific heterogeneous treatment effects, e.g., that the headline ``Related articles'' treatment is more effective for those with above vs. below median digital literacy, we would again average across the relevant scores, marginalizing over an equal distribution of levels of the respondent factor, and would compare estimates across the two groups. 
