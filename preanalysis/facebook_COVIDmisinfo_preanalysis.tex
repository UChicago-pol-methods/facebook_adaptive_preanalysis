...
\end{align}
\end{hypothesis}\todo{Further secondary hypotheses?}
...
\section{Analysis}\label{analysis}\todo{Include factorial model for effects?}
...
\subsection{Simulations and design hyperparameters}\label{simulations}
