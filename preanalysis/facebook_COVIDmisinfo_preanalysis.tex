...
Covariate measurement plays an important role in our contextual adaptive experiment. We measure pre-treatment covariates that we use to assign treatment probabilities (as detailed in Section X).\todo{@Molly pls improve language :)} 
...
\textbf{Predictions about covariates/heterogeneity:}\todo{@Molly do you think we should include this kind of thing here?}
\textcolor{red}{
\begin{enumerate}
