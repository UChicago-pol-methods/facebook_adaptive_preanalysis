...
\textcolor{red}{
Treatments 1, 2, 3, 8, 9 and 10 are taken from interventions adopted by industry partners including Facebook, Twitter and WhatsApp. \textbf{cite study finds FB tips effective...} Treatment 11 (real information) is a similar headline-level treatment that could be adopted by industry partners -- rather than flagging or presenting warnings we test whether providing a simple true statement improves our sharing outcomes of interest (E.g. reduces sharing of false information). \textbf{Cite nyhan study that finds more true info helpful}%depending on what video treatment used could also go here
Treatments 4, 6, and 7 are taken from academic studies. Emotion Suppression .... The Pledge treatment (5) was adapted from the types of treatments used by political campaigns to get subjects to pledge to vote or support a particular candidate. 
}
